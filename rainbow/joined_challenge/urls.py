...
router.register(
    r'joined_challenge/event_participant_joined_challenge',
    joined_challenge.EventParticipantJoinedChallengeViewSet)
router.register(r'joined_challenge/school_gsa_joined_challenge', joined_challenge.SchoolGSAJoinedChallengeViewSet)
router.register(
    r'joined_challenge/event_organizer_joined_challenge',
    joined_challenge.EventOrganizerJoinedChallengeViewSet)
...
router.register(r'joined_challenge/user_answer', joined_challenge.UserAnswerViewSet)
